...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { description: @machine.description, model: @machine.model, tipping: @machine.tipping }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { description: @machine.description, model: @machine.model, tipping: @machine.tipping }
    assert_redirected_to machine_path(assigns(:machine))
  end
